...
const API = {
    ...
    adicionarVacinaPaciente: (dados) => apiCall('/api/paciente/vacina', 'POST', dados),
    editarVacinaPaciente: (id, dados) => apiCall('/api/paciente/vacina/' + id, 'PUT', dados),
    removerVacinaPaciente: (id) => apiCall('/api/paciente/vacina/' + id, 'DELETE'),
